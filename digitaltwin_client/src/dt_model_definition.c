...
static const char DigitalTwinSampleModelDefinition_ComponentName[] = "urn_azureiot_ModelDiscovery_ModelDefinition";
...
DIGITALTWIN_CLIENT_RESULT DigitalTwin_ModelDefinition_Create(MODEL_DEFINITION_CLIENT_HANDLE *md_handle_result, DIGITALTWIN_INTERFACE_CLIENT_HANDLE *md_interface_client_handle)
{
    ...
    {
        if ((result = DigitalTwin_InterfaceClient_Create(DigitalTwinSampleModelDefinition_InterfaceId, DigitalTwinSampleModelDefinition_ComponentName, DTMD_InterfaceRegisteredCallback, (void *)md_handle, &interfaceClientHandle)) != DIGITALTWIN_CLIENT_OK)
        {
            LogError("MODEL_DEFINITION_INTERFACE: Unable to allocate interface client handle for interfaceId=<%s>, componentName=<%s>, error=<%s>", DigitalTwinSampleModelDefinition_InterfaceId, DigitalTwinSampleModelDefinition_ComponentName, MU_ENUM_TO_STRING(DIGITALTWIN_CLIENT_RESULT, result));
        ...
        {
            LogInfo("MODEL_DEFINITION_INTERFACE: Created DIGITALTWIN_INTERFACE_CLIENT_HANDLE. interfaceId=<%s>, componentName=<%s>, handle=<%p>", DigitalTwinSampleModelDefinition_InterfaceId, DigitalTwinSampleModelDefinition_ComponentName, interfaceClientHandle);
