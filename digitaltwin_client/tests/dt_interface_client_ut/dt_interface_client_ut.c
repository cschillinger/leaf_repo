...
static const char* dtTestComponentName1 = DT_TEST_INTERFACE_NAME_1;
...
static void set_expected_calls_for_DT_InterfaceClient_CreateTelemetryMessage()
{
...
TEST_FUNCTION(DT_InterfaceClient_CreateTelemetryMessage_ok)
{
    //arrange
    IOTHUB_MESSAGE_HANDLE messageHandle = NULL;
    set_expected_calls_for_DT_InterfaceClient_CreateTelemetryMessage();
...
TEST_FUNCTION(DT_InterfaceClient_CreateTelemetryMessage_NULL_interfaceId_fails)
{
    //arrange
    IOTHUB_MESSAGE_HANDLE messageHandle = NULL;
